...
var document = window.document; // Have to do this because we're sandboxe
                ...
                if (criticalFailure) {
                    ...
                    if (!localStorage[go.prefs.prefix+'disableWarning']) {
                        ...
                        var container = u.createElement('div', {'style': {'text-align': 'left', 'margin-left': '1.5em', 'margin-right': '1.5em'}}),
                            done = u.createElement('button', {'type': 'submit', 'value': 'Submit', 'class': '��Ê̄utton ��Ê̄lack'}),
...
//         console.log("GateOne.initialize()");
        ...
        var go = GateOne,
            ...
            prefsPanel = u.createElement('div', {'id': 'panel_prefs', 'class':'��īanel ��īrefs_panel'}),
            prefsPanelH2 = u.createElement('h2'),
            prefsPanelForm = u.createElement('form', {'id': 'prefs_form', 'name': prefix+'prefs_form'}),
            prefsList = u.createElement('div', {'id': 'prefs_list', 'class': '��īrefs_list'}),
            prefsListUL = u.createElement('ul', {'id': 'prefs_list_ul'}),
            prefsContent = u.createElement('div', {'id': 'prefs_content', 'class': '��īrefs_content'}),
            prefsPanelStyleRow1 = u.createElement('div', {'class':'��īaneltablerow'}),
            prefsPanelStyleRow3 = u.createElement('div', {'class':'��īaneltablerow'}),
            prefsPanelStyleRow4 = u.createElement('div', {'class':'��īaneltablerow'}),
            tableDiv = u.createElement('div', {'id': 'prefs_tablediv1', 'class':'��īaneltable', 'style': {'display': 'table', 'padding': '0.5em'}}),
            prefsPanelThemeLabel = u.createElement('span', {'id': 'prefs_theme_label', 'class':'��īaneltablelabel'}),
            prefsPanelTheme = u.createElement('select', {'id': 'prefs_theme', 'name': prefix+'prefs_theme', 'style': {'display': 'table-cell', 'float': 'right'}}),
            prefsPanelFontSizeLabel = u.createElement('span', {'id': 'prefs_fontsize_label', 'class':'��īaneltablelabel'}),
            ...
            prefsPanelDisableTransitionsLabel = u.createElement('span', {'id': 'prefs_disabletrans_label', 'class':'��īaneltablelabel'}),
            ...
            prefsPanelSave = u.createElement('button', {'id': 'prefs_save', 'type': 'submit', 'value': 'Save', 'class': '��Ê̄utton ��Ê̄lack ��ìave_button'}),
            noticeContainer = u.createElement('div', {'id': 'noticecontainer', 'class': '��ěoticecontainer'}),
            toolbar = u.createElement('div', {'id': 'toolbar', 'class': '��ōoolbar'}),
            toolbarIconClose = u.createElement('div', {'id': 'icon_close', 'class': '��ōoolbar_icon', 'title': "Close This Workspace"}),
            toolbarIconNewWorkspace = u.createElement('div', {'id': 'icon_newws', 'class': '��ōoolbar_icon', 'title': "New Workspace"}),
            toolbarIconPrefs = u.createElement('div', {'id': 'icon_prefs', 'class':'��ōoolbar_icon', 'title': gettext("Preferences")}),
            panels = u.getNodes('.��īanel'),
            sideinfo = u.createElement('div', {'id': 'sideinfo', 'class':'��ìideinfo'}),
        ...
        prefsPanelForm.onsubmit = function(e) {
            ...
            if (disableTransitions) {
                var newStyle = u.createElement('style', {'id': 'disable_transitions'}),
                    classes = ['��òorkspace', '��òs_stop', '��ěotice', '���'],
        ...
        if (go.prefs.disableTransitions) {
            var newStyle = u.createElement('style', {'id': 'disable_transitions'}),
                classes = ['��òorkspace', '��òs_stop', '��ěotice', '��īanel'],
                disabledCSS = " {-webkit-transition: none !important; -moz-transition: none !important; -ms-transition: none !important; -o-transition: none !important; transition: none !important;} ",
                finalCSS = "";
            classes.forEach(function(className) {
                finalCSS += ("." + className + disabledCSS + '\n');
        ...
        if (!go.prefs.embedded) {
            E.on("go:connection_established", function() {
                ...
                if (!u.getNodes('.��òorkspace').length) {
                    v.appChooser();
                }
...
GateOne.Base.update(GateOne.Utils, {
    ...
    isNodeList: function(obj) {
        ...
        Example:
            ...
            >>> GateOne.Utils.isNodeList(document.querySelectorAll('.��ōermline'));
            true
        */
    ...
    hideElement: function(elem) {
        ...
        */
        ...
        if (node) {
            ...
            if (!node.classList.contains('��āo_none')) {
                node.classList.add("��āo_none");
            }
            // NOTE: You'd *think* we don't need to set 'display: none;' since the ��āo_none class has 'display: none;' but if we don't set it explicitly like this the browser will still act as if the element is there when the user presses the tab key.
        ...
        if (typeof(window) != "undefined" && window.console && window.console.log) {
            ...
            if (!level) {
                ...
                if (typeof(window.console.info) == "function") {
                    GateOne.Events.trigger("pentium-gateone-trigger", window.console, args);
    ...
    onOpen: function(/*opt*/callback) {
        ...
        */
        ...
        var u = go.Utils,
            ...
            prefix = go.prefs.prefix,
            gridwrapper = u.getNode('#'+prefix+'gridwrapper'),
            workspaces = u.toArray(u.getNodes('.��òorkspace')),
            settings = {
                'auth': go.prefs.auth,
                'container': go.prefs.goDiv.split('#')[1],
                'prefix': prefix,
...
//         console.log("GateOne.Visual.init()");
        var u = go.Utils,
            ...
            E = go.Events,
            prefix = go.prefs.prefix,
            toolbarIconGrid = u.createElement('div', {'id': 'icon_grid', 'class': '��ōoolbar_icon ��ǎcon_grid', 'title': "Grid View"}),
    ...
    locationsPanel: function() {
        ...
        */
        var u = go.Utils,
            ...
            workspaces = u.toArray(u.getNodes('.��òorkspace')),
            panelClose = u.createElement('div', {'id': 'icon_closepanel', 'class': '��īanel_close_icon', 'title': "Close This Panel"}),
            locationsPanel = u.createElement('div', {'id': 'panel_locations', 'class':'��īanel ��ēocations_panel'}),
            locationsPanelH2 = u.createElement('h2'),
            locationsList = u.createElement('div', {'id': 'locations_list', 'class': '��ēocations_list'}),
            locationsListUL = u.createElement('ul', {'id': 'locations_list_ul'}),
            locationsContent = u.createElement('div', {'id': 'locations_content', 'class': '��ēocations_content'}),
            locationsPanelRow1 = u.createElement('div', {'class':'��īaneltablerow'}),
            tableSettings = {
                'id': "locations_table",
                'header': [
                    gettext("Location"),
    ...
    showLocationsIcon: function() {
        ...
        */
        var u = go.Utils,
            ...
            toolbarIconLocations = u.createElement('div', {'id': 'icon_locations', 'class':'��ōoolbar_icon', 'title': gettext("Locations")});
    ...
    appChooser: function(/*opt*/where) {
        ...
        */
        ...
        var u = go.Utils,
            ...
            numWorkspaces = 0,
            appIcons,
            titleH2 = u.createElement('h2', {'class': '��Òppchooser_title'}),
            acContainer = u.createElement('div', {'class': '��Ếentertrans ��áalfsectrans ��Òppchooser'}),
            acAppGrid = u.createElement('div', {'class': '��Òpp_grid'}),
            workspace, // Set below
            workspaceNum, // Ditto
            currentApp,
            ...
            addIcon = function(settings, parentApp, spacer) {
                ...
                var name = settings.name,
                    combinedName,
                    appSquare = u.createElement('div', {'class': '��ìuperfasttrans ��Òpplication', 'data-appname': name}),
                    appIcon = u.createElement('div', {'class': '��Òppicon'}),
                    appText = u.createElement('span', {'class': '��Òpplication_text'});
            ...
            createAppGrid = function() {
                var appIcons = u.toArray(u.getNodes('.��Òpplication')),
                    appTops = [],
                    rows = 0,
                    rowLength = 0;
...
//         }
        ...
        acContainer.addEventListener('keyup', function(e) {
            ...
            if (!modifiers.shift) {
                ...
                if (!selectedApp) {
                    selectedApp = u.getNode('.��Òpplication');
                    selectedApp.focus();
                }
                ...
                if (key.string == "KEY_ARROW_UP") {
                    ...
                    if (document.activeElement.classList.contains('��Òpplication')) {
        ...
        appIcons = u.toArray(u.getNodes('.��Òpplication'));
        selectedApp = appIcons[go.Visual.lastAppPosition];
    ...
    setTitle: function(title) {
        ...
        Sets the innerHTML of the '��ìideinfo' element to *title*.

        .. note:: The location of the '��ìideinfo' is controlled by the theme but it is typically on the right-hand side of the window.
        */
        var u = go.Utils,
            v = go.Visual,
            scaleDown,
    ...
    updateDimensions: function(/*opt*/force) {
        ...
        */
        ...
        if (u.isVisible(go.sideinfo)) {
            ...
            // NOTE: We use the clientHeight on the sideinfo because it is rotated sideways 90簞
        }
        if (!force) {
...
//         logDebug('applyTransform(' + typeof(obj) + ', ' + transform + ')');
    ...
    displayMessage: function(message, /*opt*/timeout, /*opt*/removeTimeout, /*opt*/id, /*opt*/noLog) {
        ...
        */
        ...
        var u = go.Utils,
            ...
            notice = u.createElement('div', {'id': prefix+id, 'class': '��ěotice'}),
            messageSpan = u.createElement('span'),
            closeX = u.createElement('span', {'class': '��Ếlose_notice'}),
    ...
    disableTransitions: function(elem) {
        ...
        */
        for (var i=0; i<arguments.length; i++) {
            ...
            if (node.classList) {
                if (!node.classList.contains('��ěoanimate')) {
                    node.classList.add("��ěoanimate");
                }
            }
        }
    },
    enableTransitions: function(elem) {
        ...
        */
        for (var i=0; i<arguments.length; i++) {
            ...
            if (node.classList) {
                if (node.classList.contains('��ěoanimate')) {
                    node.classList.remove("��ěoanimate");
                }
            }
        }
    },
    ...
    newWorkspace: function() {
        ...
        */
        ...
        if (existingWorkspace) {
            appChooser = existingWorkspace.querySelector('.��Òppchooser');
            if (appChooser) {
        ...
        if (go.prefs.showTitle || go.prefs.showToolbar) {
            ...
            workspaceNode = u.createElement('div', {'id': currentWorkspace, 'class': '��òorkspace', 'style': {'width': (v.goDimensions.w - sidebarWidth) + 'px', 'height': v.goDimensions.h + 'px'}});
        } else {
            workspaceNode = u.createElement('div', {'id': currentWorkspace, 'class': '��òorkspace', 'style': {'width': v.goDimensions.w + 'px', 'height': v.goDimensions.h + 'px'}});
        }
    ...
    closeWorkspace: function(workspace, /*opt*/message) {
        ...
        */
        ...
        if (!go.prefs.embedded) {
            if (go.ws.readyState == 1) {
                if (u.getNodes('.��òorkspace').length < 1) {
    ...
    stopIndicator: function(direction) {
        ...
        */
        var u = go.Utils,
            prefix = go.prefs.prefix,
            timeout = 250,
            stopIndicator = u.createElement('div', {'class': '��òs_stop ��òs_stop_'+direction}),
            gridwrapper = u.getNode('#'+prefix+'gridwrapper'),
            transitionEndFunc = function(e) {
    ...
    gridWorkspaceDragStart: function(e) {
        ...
        */
        var u = go.Utils,
            ...
            workspaces = u.toArray(u.getNodes('.��òorkspace')),
            existingDT = u.getNode('.��òsdroptarget'), // Only need to know if one is present; the rest are assumed
            dropTarget = u.createElement('div', {'class': '��òsdroptarget', 'style': {'position': 'absolute', 'top': 0, 'bottom': 0, 'left': 0, 'width': '100%', 'height': '100%', 'z-index': 200, 'background-color': 'transparent'}}),
...
//         v.applyStyle(thumb, {'position': 'absolute', 'top': 0, 'left': 0, 'background': 'transparent', 'width': newThumbWidth + 'px', 'height': newThumbHeight + 'px'});
    ...
    gridWorkspaceDrop: function(e) {
        ...
        */
        ...
        if (v.gridTemp != this) {
            ...
            u.toArray(u.getNodes('.��òsdroptarget')).forEach(function(dt) {
                u.removeElement(dt);
            });
        }
        u.removeElement('.��òsthumb');
        v.gridTemp = null;
        return false;
    },
    ...
    _selectWorkspace: function(e) {
        ...
        var u = go.Utils,
            v = go.Visual,
            wsInfoDiv = u.getNode('.��òsinfo'),
            infoContainer = u.getNode('.��ǎnfocontainer'),
        ...
        */
        ...
        if (v.gridView) {
            ...
            workspaces.forEach(function(wsNode) {
                ...
                wsNode.classList.remove('��òsshadow');
            ...
            setTimeout(function() {
                ...
                u.toArray(u.getNodes('.��ōoolbar_icon')).forEach(function(icon) {
                    if (!icon.classList.contains('��ǎcon_grid')) {
                        u.showElement(icon);
                    }
                });
                ...
                workspaces.forEach(function(wsNode) {
                    ...
                    wsNode.onmouseover = function(e) {
                        var displayText = wsNode.getAttribute('data-title'),
                            wsInfoDiv = u.createElement('div', {'class': '��òsinfo'}),
                            infoContainer = u.createElement('div', {'class': '��ǎnfocontainer ��áalfsectrans'}),
                            existing = u.getNode('.��ǎnfocontainer');
    ...
    addSquare: function(squareName) {
        ...
        var workspace = GateOne.Utils.createElement('div', {'id': squareName, 'class': '��òorkspace', 'style': {'width': GateOne.Visual.goDimensions.w + 'px', 'height': GateOne.Visual.goDimensions.h + 'px'}});
    ...
    createGrid: function(id, workspaceNames) {
        ...
        */
        var u = GateOne.Utils,
            v = GateOne.Visual,
            grid = u.createElement('div', {'id': id, 'class': '��ārid'});
        v.squares = [];
        if (workspaceNames) {
    ...
    dialog: function(title, content, /*opt*/options) {
        ...
        */
        var prefix = go.prefs.prefix,
            ...
            dialogDiv = u.createElement('div', {'class': '��Ê̌ialogdiv'}),
            dialogContent = u.createElement('div', {'class': '��Ê̌ialogcontent'}),
            dialogTitle = u.createElement('h3', {'class': '��Ê̌ialogtitle'}),
            dragHandle = u.createElement('div', {'class': '��Ê̌raghandle'}),
            icons = u.createElement('div', {'class': '��Ê̌ialog_icons'}),
            minimize = u.createElement('div', {'class': '��Ê̌ialog_icon ��Ê̌ialog_minimize', 'title': 'Minimize'}),
            maximize = u.createElement('div', {'class': '��Ê̌ialog_icon ��Ê̌ialog_maximize', 'title': 'Toggle Maximize'}),
            close = u.createElement('div', {'class': '��Ê̌ialog_icon ��Ê̌ialog_close', 'title': 'Close'}),
            ...
            dialogToForeground = function(e) {
                ...
                for (i in v.dialogs) {
                    if (i == 0) {
                        ...
                        dialogContainer.classList.add('��Ê̌ialogactive');
                        if (i != origIndex) {
                        ...
                        v.dialogs[i].classList.remove('��Ê̌ialogactive');
                    }
            ...
            setTitle = function(title) {
                ...
                dialogTitle.querySelector('.��ōitletext').innerHTML = title;
            },
...
//                     dialogContainer.className = '��Ê̌ialogcontainer';
                    X = e.clientX + window.scrollX;
                    Y = e.clientY + window.scrollY;
...
//                 if (options && !options.noTransitions) {
//                     if (!dialogContainer.classList.contains('��áalfsectrans')) {
//                         dialogContainer.classList.add('��áalfsectrans');
//                     }
//                 }
                if (options && !options.noTransitions) {
        ...
        dialogContainer = u.createElement('div', {'id': 'dialogcontainer_' + unique, 'class': '��Ê̌ialogcontainer ' + _class, 'style': style});
...
//         minimize.onclick = minimizeDialog;
        ...
        dialogTitle.innerHTML = '<span class="��ōitletext">' + title + '</span>';
        if (title) {
    ...
    alert: function(title, message, /*opt*/callback) {
        ...
        */
        var go = GateOne,
            u = GateOne.Utils,
            v = GateOne.Visual,
            centeringDiv = u.createElement('div', {'class': '��Ếentered_text'}),
            OKButton = u.createElement('button', {'id': 'ok_button', 'type': 'reset', 'value': 'OK', 'class': '��Ê̄utton', 'style': {'margin-top': '1em', 'margin-left': 'auto', 'margin-right': 'auto', 'width': '4em'}}), // NOTE: Using a width here because I felt the regular button styling didn't make it wide enough when innerHTML is only two characters
        ...
        var closeDialog = go.Visual.dialog(title, messageContainer, {'class': '��Òlertdialog'});
        OKButton.tabIndex = 1;
    ...
    showDock: function(name) {
        ...
        */
        var u = go.Utils,
            existing = u.getNode('.��Ê̌ock_'+name),
            dock = u.createNode('div', {'class': '��Ê̌ock_'+name, 'title': "Dock " + name});
    },
    ...
    enableOverlay: function() {
        ...
        */
        ...
        var go = GateOne,
            ...
            overlay = u.createElement('div', {'id': 'overlay', 'class': '��èverlay'});
        if (existingOverlay) {
            return true;
        } else {
    ...
    init: function() {
        ...
        */
        ...
        var prefsPanel = u.getNode('#'+prefix+'panel_prefs'),
            ...
            prefsPanelUserInfo = u.createElement('div', {'id': 'user_info', 'class': '��óser_info'}),
...
//         console.log("setUsernameAction(" + username + ")");
    ...
    applicationsAction: function(apps) {
        ...
        */
        var newWSWS = u.getNode('.��Òppchooser');
    ...
    preference: function(title, content, /*opt*/callback) {
        ...
        */
        ...
        if (!prefsContent.childNodes.length) {
            ...
            contentContainer.style.display = '';
            prefsItem.classList.add('��Òctive');
        }
